...
namespace DirectX.Capture
{
	...
	public class Capture
	{
        ...
        private static Size ExpandToBound(System.Drawing.Size image, System.Drawing.Size boundingBox)
        {
        ...
        public void HandleResize(Size inAvailableSize, Size inProportionalVideoSize)
        {
            if (this.videoWindow != null)
            {

                int left = (inAvailableSize.Width - inProportionalVideoSize.Width) / 2;
                int top = (inAvailableSize.Height - inProportionalVideoSize.Height) / 2;

                this.videoWindow.SetWindowPosition(left, top, inProportionalVideoSize.Width, inProportionalVideoSize.Height);
            }
